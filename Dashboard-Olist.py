...
all_df = pd.read_csv("https://raw.githubusercontent.com/albbagus/dicoding/main/olist_df.csv")
...
with st.sidebar:
    ...
    st.image("https://raw.githubusercontent.com/albbagus/dicoding/main/olist_store.png")
